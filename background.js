...
// C. 2014-2020 Nagisa Day
// Uses the tool color-thief by lokesh from github.
...
var rainbowTabs = function() {
  ...
  var hsvToHex = function(hsv) {
    ...
    switch (Math.floor(h)) {
      case 0:
        return rgbToHex([c, x, z]);
      case 1:
        return rgbToHex([x, c, z]);
      case 2:
        return rgbToHex([z, c, x]);
      case 3:
        return rgbToHex([z, x, c]);
      case 4:
        return rgbToHex([x, z, c]);
      case 5:
        return rgbToHex([c, z, x]);
      default:
        return '000000';
    }
  };
